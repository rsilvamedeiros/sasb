...
@section('content')
<h1 class="ls-title-intro ls-ico-user-add">Criar Novo Documento de Transferência</h1>
<div class="ls-box">
<div class="ls-no-padding-bottom">
      ...
      <div class="ls-modal-body" id="myModalBody">
        ...
        <table class="ls-table ls-table-striped ls-bg-header">
          ...
          @if (count($clients))
            ...
            @endforeach
          @else
            <p>Instituição não encontrado!</p>
          @endif
        </table>
      </div>
  ...
  <!-- FIM modal -->
  <hr>
  <h5 class="ls-title-5">Criar Documento de Transferência:</h5>
  <form method="POST" action="{{ route('transferencia.postAdd') }}" class="ls-form row">
    ...
    <fieldset>
      ...
      <label class="ls-label col-md-12">
        ...
        <input type="text" name="brand" placeholder="Nome da escola" required >
      </label>
      <label class="ls-label col-md-12">
